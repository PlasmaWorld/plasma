...
export default function TokenPage({ nft, contractMetadata }: Props) {
  ...
  async function buyListing() {
    ...
    if (auctionListing?.[0]) {
      // Attempt to make a bid in the auction
      txResult = await marketplace?.englishAuctions.makeBid(
        auctionListing[0].id,
        bidValue // Make sure this value is correctly formatted
      );
              ...
              <div className={styles.traitsContainer}>
                {transferEvents?.map((event, index) => (
                  ...
                  >
                    ...
                    <div className={styles.eventContainer}>
                    <Link href={`${ETHERSCAN_URL}/tx/${event.transaction.transactionHash}`} passHref>
                    <a target="_blank" className={styles.txHashArrow}>â</a>
                    </Link>
  ...
  <a className={styles.nftOwnerContainer}>
    <div
